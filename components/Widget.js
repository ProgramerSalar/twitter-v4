        ...
        <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5 ">
            <div className="w-[90%] xl:w-[75%] sticky top-0 py--1.5 z-50 ">
                <div className="flex items-center p-3 rounded-full bg-red-300 relative ">
                    <MagnifyingGlassIcon className="h-6 z-52 text-gray-500 "/>
            ...
            <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%]">
                <h4 className="font-bold text-xl px-4">What's happaning</h4>
            ...
            <div className="sticky top-16 text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]">
                ...
                <button className="text-blue-300 pl-4 pb-4 hover:text-blue-400" onClick={()=> setRandomUserNum(randomUsernum + 3)}>Show more</button>
            </div>
