...
import {HomeIcon , HashtagIcon , BellIcon , InboxIcon , BookmarkIcon , ClipboardIcon , UserIcon , EllipsisHorizontalIcon , EllipsisHorizontalCircleIcon } from "@heroicons/react/24/solid"
    ...
    return(
        <div className=" sm:flex flex-col p-2 xl:items-start fixed h-full">
            ...
            <div  className="hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto">
                ...
                alt="user-img"
                className="h-6 w-10 rounded-full xl:mr-2"/>
